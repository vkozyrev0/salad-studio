...
| `ai_helper.py` | 1129 | Sound; the largest untested-by-name module | L4 |
...
The largest modules: `salad_status` 8 (`apply_policy`, `find_group_by_gateway`,
...
3. **N11.** Cover the `salad_status` Policy / Reallocate path
   ...
   `theme` style helpers. These are the thinnest coverage on a live UI.
